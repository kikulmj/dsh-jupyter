...
function createEntry(controller: TerminalController): HTMLButtonElement {
  ...
  entry.innerHTML = '<span class="dst-entry-icon">' + ICON + '</span><span class="dst-entry-label">终端</span>'
...
function placeEntry(root: HTMLElement, entry: HTMLButtonElement): boolean {
  ...
  if (entry.parentElement !== root) {
    ...
    // terminal sits after the whole family block (task board, then ssh).
 ...
 */
export function mountSidebarEntry(controller: TerminalController): () => void {
