...
export interface JupyterError {
    code: 'workspace-unknown' | 'path-outside-root' | 'not-found' | 'not-notebook' | 'write-conflict' | 'write-failed' | 'kernel-unavailable' | 'kernel-busy' | 'internal';
    message: string;
}
